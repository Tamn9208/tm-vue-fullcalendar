...
<div>
    ...
    <full-calendar class="test-fc" :events="fcEvents" first-day='1' locale="zh-cn" @changeMonth="changeMonth" @eventClick="eventClick" @dayClick="dayClick" @moreClick="moreClick">
